...
if __name__ == '__main__':
    ...
    # DocProcess.creatZip(method="allfile",filepath=r"D:\Work_Spaces\PyCharm_Project\UiAutomationFramework\Common",target_path="aaaa.gzip")
    # DocProcess.getFileState(file_path=r"E:\WorkSpace\PycharmProjects\UiAutomationFramework\Common\not_exist.py")
    # DocProcess.copyFile(filepath=r"D:\Work_Spaces\PyCharm_Project\UiAutomationFramework\Common",target=r"D:\Work_Spaces\PyCharm_Project\UiAutomationFramework\Common\COPYS")
    # DocProcess.removeFile(filepath=r"..\Result\Logs\2020-09-21\Default_Logs\2020-09-21.log")
    # DocProcess.makeFile(filepath=r"D:\Work_Spaces\PyCharm_Project\UiAutomationFramework\Common\AA\aaa")
    # DocProcess.getDirList(filePath=r"D:\Work_Spaces\PyCharm_Project\UiAutomationFramework\Common")